    ...
    <main className="w-full h-screen">
      <Navbar />
        <div className="mx-44 mt-[150px] max-lg:mt-[130px] max-lg:mx-[1.8rem] bg-gray-100 px-10 py-6 pb-10 max-sm:px-7 rounded-lg">
            ...
            <p className='text-gray-600 text-sm mt-2  text-center'>Last updated on 24-04-2024 13:47:52</p>

            <div className='mt-6'>
                <p>   
                    These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
                    agreement by and between <br/> <span className='font-semibold'>NUTRIVORE LABS PRIVATE LIMITED</span>, ( “Website Owner” or “we” or
                    “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or
                    services (as applicable) (collectively, “Services”).<br/>
                </p>
                <p className='mt-2'>
                ...
                <p className='mt-4'>The use of this website or availing of our Services is subject to the following terms of use:</p>
            </div>
